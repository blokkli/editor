...
For this feature to work the `getHostEntities()` method must also be implemented
— the dialog reuses the workspaces provider's host entity list, filtered to
entities of the same bundle as the current page.
