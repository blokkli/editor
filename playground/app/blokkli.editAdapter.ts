...
export default defineBlokkliEditAdapter((ctx) => {
  ...
  const adapter: FullBlokkliAdapter<MutatedState> = {
    ...
    getBlokkliUsers() {
      return Promise.resolve(
        entityStorageManager.storages.user.loadAll().map((u) => ({
          id: u.uuid,
          name: u.getName(),
  ...
  const mockChartSources: MockChartSource[] = [
    ...
    {
      id: 'winterthur-population',
      label: 'Winterthur Population 2025',
      description:
        'Age pyramid by sex and nationality (Schweiz / Ausland), source: opendata.swiss',
      categories: [
        '00-04',
        '05-09',
        '10-14',
      ...
      series: [
        ...
        },
        {
          name: 'Frauen Ausland',
          data: [
            735, 872, 818, 643, 809, 1253, 1678, 1876, 1692, 1341, 1112, 907,
            711, 480, 328, 282, 200, 164, 41, 9,
          ],
        },
        {
          name: 'Frauen Schweiz',
