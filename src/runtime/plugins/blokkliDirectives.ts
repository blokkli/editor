...
export default defineNuxtPlugin({
  ...
  setup(nuxtApp) {
    ...
    nuxtApp.vueApp.directive('blokkli-droppable-item', {
      mounted(el: HTMLElement, binding, vnode) {
        ...
        app.directive.registerDroppableItem(el, fieldName, entity, index)
      },
      ...
      beforeUnmount(el: HTMLElement, binding, vnode) {
        ...
        app.directive.unregisterDroppableItem(el, fieldName, entity)
      },
    })
  },
})
