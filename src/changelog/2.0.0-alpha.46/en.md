...
When editing text fields, common typographic patterns are now automatically
...
replacements can be undone with Ctrl+Z.

#### Undo/redo in text fields

Text fields now have a proper undo/redo history. Use Ctrl+Z to undo and
