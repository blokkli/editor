...
const paramsSchema = z.object({
  ...
  parentBundle: z
    .string()
    .optional()
    .describe('Filter to paragraphs whose parent is this bundle'),
  inField: z
    .string()
    .optional()
    .describe('Filter to paragraphs in a field with this name'),

  // Content filters
  containsText: z
    .string()
    .optional()
    .describe('Filter to paragraphs containing this text (case-insensitive)'),
...
export default defineBlokkliAgentTool({
  ...
  description:
    'Find paragraphs matching multiple filter criteria. Supports filtering by bundle, structure (nesting, parent, field), content, and options. Returns paginated results. containsText does simple case-insensitive substring matching. For regex or match snippets, use search_text instead.',
  category: 'query',
  volatile: true,
  lazy: true,
  prunedSummary: (r) =>
