...
function stripSchemaOverhead(obj: unknown): unknown {
  ...
  if (typeof obj === 'object' && obj !== null) {
    ...
    for (const [key, value] of Object.entries(obj)) {
      ...
      // propertyNames is a JSON Schema Draft 2020-12 keyword generated by
      // Zod v4 for z.record(). It's redundant (JSON keys are always strings)
      // and confuses LLMs that don't understand this keyword.
