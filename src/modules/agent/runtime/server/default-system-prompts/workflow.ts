...
export default defineBlokkliAgentSystemPrompt({
  ...
  getPrompt: () => {
    const steps = [
      'For long running tasks (e.g. building a full page, importing content, restructuring multiple sections), use create_plan to outline the steps first. Each step needs a short label (shown to the user) and a detailed description (your own detailled notes on what to do to help you remember). The user will review and approve the plan before you proceed.',
