...
- PREFERRED: Use the \`children\` property on each block to create entire nested structures in a SINGLE add_blocks call! The \`children\` property is a record keyed by block field name, with arrays of child blocks. Children can also have children (recursive, no depth limit).
