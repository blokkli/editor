export default {
  ...
  pageIsPublishedWithPendingChanges:
    'Seite ist publiziert (Änderungen ausstehend)',
  pageIsNotPublished: 'Seite ist nicht publiziert',

  exitTitle: 'Schliessen',
  exitDescription: 'Editor schliessen ohne veröffentlichen',

  fieldAreasShow: 'Inhaltsbereiche anzeigen',
  fieldAreasHide: 'Inhaltsbereiche verstecken',

  gridShow: 'Grid anzeigen',
  gridHide: 'Grid verstecken',
  ...
  importExistingDialogLead:
    'Importieren Sie Inhalte von einer bestehenden Seite. Die Elemente werden an das Ende der Liste hinzugefügt. Diese Aktion kann rückgängig gemacht werden.',
  ...
  libraryDialogLead:
    'Wenn Sie ein Element zur Bibliothek hinzufügen können Sie diesen auf mehreren Seiten gleichzeitig verwenden. Änderungen an diesem Element sind dann sofort auf allen Seiten publiziert.',
  ...
  maskShow: 'Inhaltsfelder anzeigen',
  maskHide: 'Inhaltsfelder verstecken',

  ownershipNote:
    'Diese Seite wird aktuell von @name bearbeitet. Änderungen können nur von einer Person gleichzeitig durchgeführt werden.',
  ownershipTakeOwnership: 'Mir zuweisen',
  ownershipSuccess: 'Sie sind nun der Besitzer.',
  ownershipError: 'Fehler beim Zuweisen',

  previewMobileFrame: 'Mobile Vorschau',
  ...
  previewDialogLead:
    'Scannen Sie den QR-Code mit Ihrem Smartphone um die Vorschau zu öffnen.',

  publishLabel: 'Veröffentlichen',
  publishDescription: 'Alle Änderungen öffentlich machen',
  ...
  revertMenuDescription: 'Aktuell veröffentlichter Zustand Wiederherstellen',
  revertDialogTitle: 'Änderungen unwiderruflich verwerfen',
  revertDialogLead:
    'Damit werden alle Änderungen gelöscht und der aktuell publizierte Stand wiederhergestellt. Diese Aktion kann nicht rückgängig gemacht werden.',
  ...
  settingsShowImport: '"Inhalte importieren" Dialog beim Start anzeigen',
  settingsPersistArtboard: 'Position und Zoom speichern',
  settingsViewOptions: 'Seitendarstellung',
  settingsUseArtboardTrue: 'Zeichenfläche verwenden',
  settingsUseArtboardFalse: 'Normale Darstellung',
  settingsListOrientation: 'Inhaltselemente',
  settingsListOrientationVertical: 'Vertikal',
  settingsListOrientationHorizontal: 'Horizontal',
  settingsRevertSorting: 'Sortierung der Elemente zurücksetzen',
  settingsRevertAll: 'Alle Einstellungen zurücksetzen',
