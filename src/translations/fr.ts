export default {
  ...
  pageIsPublishedWithPendingChanges:
    'La page est publiée (modifications en attente)',
  ...
  importExistingDialogLead:
    'Importez du contenu d’une page existante. Les éléments seront ajoutés à la fin de la liste. Cette action peut être annulée.',
  ...
  libraryDialogLead:
    'En ajoutant un élément à la bibliothèque, vous pouvez l’utiliser sur plusieurs pages à la fois. Les modifications apportées à cet élément seront alors immédiatement publiées sur toutes les pages.',
  ...
  ownershipNote:
    'Cette page est actuellement en cours de modification par @name. Les modifications ne peuvent être effectuées que par une personne à la fois.',
  ...
  previewMobileFrame: 'Aperçu mobile',
  ...
  previewDialogLead:
    'Scannez le code QR avec votre smartphone pour ouvrir l’aperçu.',
  ...
  revertDialogLead:
    'Cela supprimera toutes les modifications et restaurera l’état actuellement publié. Cette action est irréversible.',
  ...
  settingsShowImport:
    'Afficher le dialogue "Importer des contenus" au démarrage',
  settingsPersistArtboard: 'Enregistrer la position et le zoom',
  settingsViewOptions: 'Options d’affichage du contenu',
  settingsUseArtboardTrue: 'Utiliser la zone de dessin',
  settingsUseArtboardFalse: 'Affichage normal',
  settingsListOrientation: 'Éléments de contenu',
  settingsListOrientationVertical: 'Vertical',
  settingsListOrientationHorizontal: 'Horizontal',
  settingsRevertSorting: 'Réinitialiser le tri des éléments',
  settingsRevertAll: 'Réinitialiser tous les paramètres',
