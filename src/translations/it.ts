export default {
  ...
  importExistingDialogLead:
    'Importa contenuti da una pagina esistente. Gli elementi verranno aggiunti alla fine della lista. Questa azione può essere annullata.',
  ...
  libraryDialogLead:
    'Aggiungendo un elemento alla biblioteca, puoi utilizzarlo su più pagine contemporaneamente. Le modifiche a questo elemento saranno pubblicate immediatamente su tutte le pagine.',
  ...
  ownershipNote:
    'Questa pagina è attualmente in lavorazione da @name. Le modifiche possono essere effettuate solo da una persona alla volta.',
  ownershipTakeOwnership: 'Assegna a me',
  ownershipSuccess: 'Ora sei il proprietario.',
  ownershipError: "Errore nell'assegnazione",

  previewMobileFrame: 'Anteprima mobile',
  ...
  previewDialogLead:
    "Scansiona il codice QR con il tuo smartphone per aprire l'anteprima.",
  ...
  revertDialogLead:
    'Questo eliminerà tutte le modifiche e ripristinerà lo stato attualmente pubblicato. Questa azione non può essere annullata.',
  ...
  settingsShowImport: 'Mostra dialogo "Importa contenuti" all\'avvio',
  settingsPersistArtboard: 'Salva posizione e zoom',
  settingsViewOptions: 'Opzioni di visualizzazione della pagina',
  settingsUseArtboardTrue: 'Utilizza tavola da disegno',
  settingsUseArtboardFalse: 'Visualizzazione normale',
  settingsListOrientation: 'Elementi di contenuto',
  settingsListOrientationVertical: 'Verticale',
  settingsListOrientationHorizontal: 'Orizzontale',
  settingsRevertSorting: "Resetta l'ordinamento degli elementi",
  settingsRevertAll: 'Reimposta tutte le impostazioni',
